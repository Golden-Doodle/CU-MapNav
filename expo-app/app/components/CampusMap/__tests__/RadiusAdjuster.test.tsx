...
describe("RadiusAdjuster Component", () => {
  ...
  it("renders modal when visible is true", () => {
    ...
    expect(getByTestId("radius-text")).toHaveTextContent(`${initialValue} meters`);
  });
  ...
  it("updates displayed radius when slider value changes", () => {
    ...
    expect(getByTestId("radius-text")).toHaveTextContent("750 meters");
  ...
  it("resets radius and calls onReset when reset button is pressed", () => {
    ...
    expect(getByTestId("radius-text")).toHaveTextContent("100 meters");
  ...
  it("updates radius when initialValue prop changes", () => {
    ...
    expect(getByTestId("radius-text")).toHaveTextContent("1000 meters");
    expect(getByText("1000 meters")).toBeTruthy();
  });
});
